function Home () {
  return (
    <div>
      <div id='demo-1' data-zs-src='["static/images/1.jpg", "static/images/2.jpg","static/images/3.jpg", "static/images/4.jpg"]' data-zs-overlay='dots'>
                ...
                <div class='logo'>
                  <h1>
                    <a class='navbar-brand' href=''>
                      <i class='fab fa-codepen' /> Demo Job Portal</a>
                  </h1>
                </div>
            ...
            <div class='row populor_category_grids mt-5'>
              ...
              <div class='col-md-3 category_grid'>
                <div class='view view1 view-tenth'>
                  ...
                  <div class='mask'>
                    <a href='#'>
                      <img src='static/images/p2.jpg' class='img-fluid' alt='' />
                    </a>
                  </div>
                </div>
              </div>
              ...
              <div class='col-md-3 category_grid'>
                <div class='view view2 view-tenth'>
                  ...
                  <div class='mask'>
                    <a href='#'>
                      <img src='static/images/p3.jpg' class='img-fluid' alt='' />
                    </a>
                  </div>
                </div>
              </div>
              <div class='col-md-3 category_grid'>
                <div class='view view3 view-tenth'>
                  ...
                  <div class='mask'>
                    <a href='#'>
                      <img src='static/images/p4.jpg' class='img-fluid' alt='' />
                    </a>
                  </div>
                </div>
              </div>
              ...
              <div class='tab-content' id='pills-tabContent'>
                  ...
                  <div class='menu-grids mt-4'>
                    <div class='row t-in'>
                      <div class='col-lg-8 text-info-sec'>
                        ...
                        <div class='job-post-main row'>
                          <div class='col-md-9 job-post-info text-left'>
                            ...
                            <div class='job-single-sec'>
                              ...
                              <ul class='job-list-info d-flex'>
                                <li>
                                  <i class='fas fa-briefcase' /> Comera</li>
                                <li>
                                  <i class='fas fa-map-marker-alt' /> California</li>
                                <li>
                                  <i class='fas fa-dollar-sign' /> 300000 - 500000 / Annum</li>
                              </ul>
                            </div>
                            <div class='clearfix' />
                          </div>
                          <div class='col-md-3 job-single-time text-right'>
                            <span class='job-time'>
                              <i class='far fa-heart' /> Full Time</span>
                        ...
                        <div class='job-post-main row my-3'>
                          ...
                          <div class='col-md-3 job-single-time text-right'>
                            <span class='job-time'>
                              <i class='far fa-heart' /> Part Time</span>
                            <a href='#' class='aply-btn '>Appy Now</a>
                          </div>
                        </div>
                        ...
                        <div class='job-post-main row'>
                          <div class='col-md-9 job-post-info text-left'>
                            ...
                            <div class='job-single-sec'>
                              ...
                              <ul class='job-list-info d-flex'>
                                <li>
                                  <i class='fas fa-briefcase' /> Chicago</li>
                                <li>
                                  <i class='fas fa-map-marker-alt' /> California</li>
                                <li>
                                  <i class='fas fa-dollar-sign' /> 300000 - 500000 / Annum</li>
                        ...
                        <div class='job-post-main row mt-3'>
                          <div class='col-md-9 job-post-info text-left'>
                            ...
                            <div class='job-single-sec'>
                              ...
                              <ul class='job-list-info d-flex'>
                                <li>
                                  <i class='fas fa-briefcase' /> Rennes</li>
                                <li>
                                  <i class='fas fa-map-marker-alt' /> France</li>
                                <li>
                                  <i class='fas fa-dollar-sign' /> 300000 - 500000 / Annum</li>
                              </ul>
                            </div>
                            ...
                            <div class='job-single-sec'>
                              ...
                              <ul class='job-list-info d-flex'>
                                ...
                                <li>
                                  <i class='fas fa-map-marker-alt' /> California</li>
                                <li>
                                  <i class='fas fa-dollar-sign' /> 200000 - 100000 / Annum</li>
                              </ul>
                            </div>
                            <div class='clearfix' />
                          </div>
                      ...
                      <div class='col-lg-4 text-info-sec'>
                        <img src='static/images/job-1.jpg' alt=' ' class='img-fluid' />
                      </div>
                ...
                <div class='tab-pane fade' id='pills-profile' role='tabpanel' aria-labelledby='pills-profile-tab'>
                  <div class='menu-grids mt-4'>
                    <div class='row t-in'>
                      <div class='col-lg-4 text-info-sec'>
                        <img src='static/images/job-2.jpg' alt=' ' class='img-fluid' />
                      </div>
                      <div class='col-lg-8 text-info-sec'>
        ...
        <div class='container'>
          <div class='inner-sec-w3ls py-lg-5  py-3'>
            <div class='mid-info text-center pt-3'>
              ...
              <div class='resume'>
                <a href='#' data-toggle='modal' data-target='#exampleModalCenter2'>
                  <i class='far fa-user' /> Create Acccount</a>
              </div>
            </div>
              ...
              <div class='parent-chart'>
                <div class='level lev-one top-level'>
                  <div class='flow-position'>
                    <img src='static/images/s1.jpg' alt=' ' class='img-fluid rounded-circle' />
                    <br />
                ...
                <div class='flow-chart'>
                  <div class='level lev-two last-lev'>
                    <div class='flow-position'>
                      <img src='static/images/s2.jpg' alt=' ' class='img-fluid rounded-circle' />
                      <br />
                      <strong>1.Job Vacancy</strong>
                      <br /> Lorem ipsum
                                  </div>
                    <div class='flow-position'>
                      <img src='static/images/s3.jpg' alt=' ' class='img-fluid rounded-circle' />
                      <br />
                    ...
                    <div class='flow-position'>
                      <img src='static/images/s4.jpg' alt=' ' class='img-fluid rounded-circle' />
                      <br />
                    ...
                    <div class='flow-position'>
                      <img src='static/images/s5.jpg' alt=' ' class='img-fluid rounded-circle' />
                      <br />
                      <strong>4.Screening </strong>
                      <br /> Lorem ipsum
                                  </div>
                    <div class='flow-position'>
                      <img src='static/images/s6.jpg' alt=' ' class='img-fluid rounded-circle' />
                      <br />
                    ...
                    <div class='flow-position'>
                      <img src='static/images/s7.jpg' alt=' ' class='img-fluid rounded-circle' />
                      <br />
                      <strong>6.Selecting</strong>
                      <br /> Lorem ipsum
                                  </div>
                    <div class='flow-position'>
                      <img src='static/images/s8.jpg' alt=' ' class='img-fluid rounded-circle' />
                      <br />
            ...
            <div class='row mt-5'>
                ...
                <div class='card'>
                  <div class='card-body'>
                    <div class='member-img'>
                      <img src='static/images/team1.jpg' alt=' ' class='img-fluid rounded-circle' />
                    </div>
              ...
              <div class='col-lg-3 member-main text-center'>
                <div class='card'>
                  <div class='card-body'>
                    <div class='member-img'>
                      <img src='static/images/team2.jpg' alt=' ' class='img-fluid rounded-circle' />
                    </div>
                    <div class='member-info text-center py-lg-4 py-2'>
                      <h4>Janet Levine</h4>
              ...
              <div class='col-lg-3 member-main text-center'>
                <div class='card'>
                  <div class='card-body'>
                    <div class='member-img'>
                      <img src='static/images/team3.jpg' alt=' ' class='img-fluid rounded-circle' />
                    </div>
                    <div class='member-info text-center py-lg-4 py-2'>
                      <h4>Rene Rickman</h4>
              ...
              <div class='col-lg-3 member-main text-center'>
                <div class='card'>
                  <div class='card-body'>
                    <div class='member-img'>
                      <img src='static/images/team4.jpg' alt=' ' class='img-fluid rounded-circle' />
                    </div>
                    <div class='member-info text-center py-lg-4 py-2'>
        ...
        <div class='container'>
          <div class='inner-sec-w3ls py-lg-5  py-3'>
            ...
            <div class='row mt-5'>
              ...
              <div class='card-deck'>
                <div class='card'>
                  <img src='static/images/g1.jpg' alt='Card image cap' class='img-fluid card-img-top' />
                  <div class='card-body'>
                ...
                <div class='card'>
                  <img src='static/images/g2.jpg' alt='Card image cap' class='img-fluid card-img-top' />
                  <div class='card-body'>
                ...
                <div class='card'>
                  <img src='static/images/g3.jpg' alt='Card image cap' class='img-fluid card-img-top' />
                  <div class='card-body'>
                    <h5 class='card-title'>Would Disruption Work for Your Business?</h5>
                    <p class='card-text'>Lorem ipsum dolor sit amet consectetur adipisicing elit sedc dnmo eiusmod tempor incididunt ut labore et dolore. </p>
                  </div>
            ...
            <div class='inner-sec-w3ls py-lg-5  py-3'>
              <div class='row'>
                ...
                <div class='col-md-5 app-img'>
                  <img src='static/images/mobile.png' alt=' ' class='img-fluid' />
                </div>
              </div>
            </div>
          </div>
          ...
          <div class='inner-sec-w3ls py-lg-5  py-3'>
            ...
            <div id='carouselExampleControls' class='carousel slide' data-ride='carousel'>
                  ...
                  <div class='row'>
                    <div class='col-md-6  testi-main'>
                      <div class='testi-grids row'>
                        ...
                        <div class='col-md-3 col-sm-3 col-xs-3 img-testi'>
                          <img class='img-fluid' src='static/images/team4.jpg' alt='' />
                        </div>
                    ...
                    <div class='col-md-6 testi-main'>
                      <div class='testi-grids t2 row'>
                        <div class='col-md-3 col-sm-3 col-xs-3 img-testi'>
                          <img class='img-fluid' src='static/images/team3.jpg' alt='' />
                        </div>
                        <div class='col-md-9 col-sm-9 col-xs-9 clients-info-text'>
                          <h6>Cras rutrum</h6>
                    ...
                    <div class='col-md-6  testi-main'>
                      <div class='testi-grids row'>
                        ...
                        <div class='col-md-3 col-sm-3 col-xs-3 img-testi'>
                          <img class='img-fluid' src='static/images/team2.jpg' alt='' />
                        </div>
                    ...
                    <div class='col-md-6  testi-main'>
                      <div class='testi-grids t2 row'>
                        <div class='col-md-3 col-sm-3 col-xs-3 img-testi'>
                          <img class='img-fluid' src='static/images/team1.jpg' alt='' />
                        </div>
                        <div class='col-md-9 col-sm-9 col-xs-9 clients-info-text'>
                          <h6>Cras rutrum</h6>
                          <p>Lorem ipsum dolor sit amet. enim, non convallis felis mattis.</p>
              ...
              <a class='carousel-control-next test' href='#carouselExampleControls' role='button' data-slide='next'>
                <span class='fas fa-long-arrow-alt-right' aria-hidden='true' />
